...
def main():
    ...
    parser.add_argument("--n_frames", type=int, default=32,
                        help="Frames sampled per 30s chunk (dataset has 32 saved; "
                             "use 8 for fast baseline or 32 for full-frame experiment)")
    args = parser.parse_args()

    # Override module-level constant so all downstream code sees the right value
    global N_FRAMES
